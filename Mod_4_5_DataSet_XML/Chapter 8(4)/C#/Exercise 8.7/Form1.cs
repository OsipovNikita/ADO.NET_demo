   ...
   partial class Form1 : Form
   {
      ...
      private void btnFilter2_Click(object sender, EventArgs e)
      {
         ...
         foreach (object item in lbCustomerProducts.Items)
         {
            ...
            ProdRow = custProdRow.GetParentRow(customerProducts.Relations[0]); // получение родительской строки
      ...
      private void btnFilter1_Click(object sender, EventArgs e)
      {
         ...
         DataRow[] childRows = selectedRow.GetChildRows(customerProducts.Relations[1]); // получени дочерней строки
