...
namespace Example_6_3
{
   partial class Form1 : Form
   {
      ...
      private void btnPopulate_Click(object sender, EventArgs e)
      {
        ...
        /// <summary>
        /// DataSet создается программно с набором двух таблиц
        /// </summary>
        /// <returns></returns>
      private DataSet CreateSchema()
      {
         ...
         toReturn.Tables.Add(petsTable);
            ...
            // столбец AmmalID служит первичным ключом в таблице Animal
            // и ограничением по внешнему ключу между таблицами Pets и Animal
