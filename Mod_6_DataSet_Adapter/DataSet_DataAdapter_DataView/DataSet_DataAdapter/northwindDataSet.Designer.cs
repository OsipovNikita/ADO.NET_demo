...
namespace DataSet_DataAdapter.northwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataSet_DataAdapter.Properties.Settings.Default.northwindConnectionString;
        }
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, Un" +
                ...
                " Products\r\nWHERE        (UnitPrice < @up)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@up", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(northwindDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> up) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((up.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(up.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual northwindDataSet.ProductsDataTable GetData(global::System.Nullable<decimal> up) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((up.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(up.Value));
            }
