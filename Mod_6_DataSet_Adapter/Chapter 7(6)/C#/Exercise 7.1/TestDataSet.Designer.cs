            ...
            public string LastName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'LastName\' в таблице \'UserTable\' равно DBNull.", e);
                    }
                }
                set {
...
namespace Exercise_7_1.TestDataSetTableAdapters {
    ...
    public partial class UserTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserTable] WHERE (([UserID] = @Original_UserID) AND ([FirstNam" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserTable] ([FirstName], [LastName]) VALUES (@FirstName, @Last" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserTable] SET [FirstName] = @FirstName, [LastName] = @LastName WHERE (([UserID] = @Original_UserID) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
SELECT UserID, FirstName, LastName FROM UserTable WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = Exercise_7_1.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, FirstName, LastName FROM dbo.UserTable";
        ...
        public virtual int Update(string FirstName, string LastName, int Original_UserID, string Original_FirstName, string Original_LastName) {
            return this.Update(FirstName, LastName, Original_UserID, Original_FirstName, Original_LastName, Original_UserID);
        }
    }
}
